...
/**
 * Specifies a set of tags that are required by a {@link TruffleInstrument instrument}
 * implementation. Tags referenced by {@link SourceSectionFilter filters} must also be declared as
 * required by the instrument otherwise the
 * {@link Instrumenter#attachFactory(SourceSectionFilter, ExecutionEventNodeFactory) attachement} of
 * a filter will throw an exception.
 * <p>
 ...
 * incompatible. {@link EventBinding Bindings} attached by instruments which are incompatible to the
...
public @interface RequiredTags {

    /**
     * @return the set of tags that are required by the {@link TruffleInstrument instrument}
     *         implementation.
     * @see RequiredTags class documentation for further details
     * @since 0.12
     */
    String[] value();
